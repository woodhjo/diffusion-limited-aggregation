...
this is different is to try to avoid large arrays being produced.
...
@jitclass(spec)
class DLA3D:
    def __init__(self, max_particles, agg_radius):
        # Check validity of input
        self._check_input(max_particles, agg_radius)
    ...
    def _check_input(self, max_particles, agg_radius):
...
# Make aggregate
model = DLA3D(max_particles, agg_radius)
